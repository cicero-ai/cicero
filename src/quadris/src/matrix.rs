...
Every data point consists of the following information:
    ...
    event details _eg. exact dish eaten, song / band listened to, video watched, time of day, location, etc.)

Please note, vocabulary is over 300,000 words + MWEs, all in numerical format hence why the above structs are all i32 for identifiers instead of any strings.
...
Querying is super efficient as well.  For example, say food question for dinner is wanted, and they're undecided on what they want but need to order for the family.
