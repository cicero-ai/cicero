...
impl Model {
    ...
    /// Get config
    pub fn get_config(&self) -> Box<RemoteResource> {
    ...
    /// Get vocab
    pub fn get_vocab(&self) -> Box<RemoteResource> {
    ...
    /// Get merges
    pub fn get_merges(&self) -> Box<RemoteResource> {
    ...
    /// Get modules.json
    pub fn get_modules(&self) -> Box<RemoteResource> {
    ...
    /// Get pooling config
    pub fn get_pooling_config(&self) -> Box<RemoteResource> {
    ...
    /// Get demse cpmfog
    pub fn get_dense_config(&self) -> Box<RemoteResource> {
    ...
    /// Get dense weight
    pub fn get_dense_weights(&self) -> Box<RemoteResource> {
    ...
    pub fn get_sentences_config(&self) -> Box<RemoteResource> {
    ...
    pub fn get_tokenizer_config(&self) -> Box<RemoteResource> {
